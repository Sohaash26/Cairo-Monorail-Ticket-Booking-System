...
public class Ticket {
	...
	public static int countTickets = 0; // to count tickets
    ...
    public String toString() {
        return "Ticket{" + "ticketFare=" + ticketFare + ", id=" + id + ", totalTicketFare=" + totalTicketFare + ", route=" + route + ", time_slot=" + time_slot + '}';
    }
