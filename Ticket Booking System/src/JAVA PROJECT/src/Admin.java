...
public class Admin extends Person{
	public ArrayList <Admin> admins = new ArrayList<Admin>(); // Collection of admins
	...
	public ArrayList <Ticket> tickets = new ArrayList<Ticket>(); // Collection of tickets
	...
	public void manageAcc()
	{
		...
		for(int i =0; i<admins.size();i++)
		{
			if(enteredID == admins.get(i).getID())
			{
				...
				if(admins.get(i).getAcc().getEmail().equals(null) && admins.get(i).getAcc().getPassword().equals(null))
				{
